...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Ubah Organization</h6>
      </div>
      <div class="card-body">
        <form action="{{ route('organization.update.proses') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text" name="email" value="{{ $organization->email }}" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
